...
export const EditorNameInput = ({ workflowId }: { workflowId:
string }) => {
...
// --- Sub-component: EditorBreadcrumbs ---
  ...
  return (
    <Breadcrumb>
      <BreadcrumbList>
        ...
        <BreadcrumbSeparator />
        {/* You can add the specific workflow name/item here */}
